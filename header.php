    ...
    <div class="container">
        <div class="offer">
            ...
            <div class="offer_address">
                <a href="#"
                   class="offer_address__city"><?php echo carbon_get_theme_option( 'header-company-address' ); ?></a>
            ...
            <div class="offer-links">
                ...
                <!-- + border class -->
                <a href="https://yandex.com.ge/profile/223294583947">
                    <div class="offer-links_yandex">
                        ...
                        <div class="offer-link_yandex__stars">
                        ...
                        <span class="offer-link_yandex__rating">4,9 рейтинг</span>
                    </div>
                </a>
            </div>
            ...
            <div class="offer_btn">
                ...
                <a href="http://wa.me/<?php echo substr_replace( preg_replace( "/[^0-9]/", '', carbon_get_theme_option( 'header-phone-first' ) ), '+7', 0, 1 ) ?>"
                   class="offer_btn__whatsapp btn-main">
